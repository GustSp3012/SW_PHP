            ...
            <form action="add.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input maxlength="6" type="text" class="form-control" name="produto[codigo]" required>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="produto[genero]" required>
                    </div>
                </div>
